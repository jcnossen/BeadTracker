...
public:
	...
	virtual vector2f ComputeXCor(vector2f initial, int profileWidth=32) = 0;
	virtual vector2f ComputeXCor2D() = 0;
	virtual vector2f ComputeXCorInterpolated(vector2f initial, int iterations, int profileWidth=32) = 0;
	...
	virtual vector2f ComputeQI(int iterations, int radialSteps, int angularStepsPerQuadrant, float radius, vector2f center) = 0;
	virtual vector2f ComputeBgCorrectedCOM() = 0;
