...
#define  IMG_ATTR_POCL_STATUS                   (_IMG_BASE + 0x01C6) // COntrols whether to enable the Power Over Camera Link feature.
...
#define  IMG_ERR_POCL_FAULT                         (_IMG_ERR + 0x0170) // The PoCL circuitry has faulted.
...
#define  IMG_ERR_LAST_ERROR           (_IMG_ERR + 0x173)
